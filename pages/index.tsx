...
const Home: NextPage = (): JSX.Element => {
  ...
  return (
    <div className='bg-fuchsia-900 flex justify-center items-center h-screen'>
      <div className='bg-white w-1/3 h-3/5 rounded-2xl shadow-2xl text-gray-600'>
        ...
        <div className='flex justify-center'>
          <div className='flex w-28 justify-center border-2 py-2 rounded-md hover:bg-fuchsia-100 transition ease-out duration-700 text-gray-700'>
